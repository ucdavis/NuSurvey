...
namespace NuSurvey.Tests.ControllerTests.SurveyResponseControllerTests
{
    public partial class SurveyResponseControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodStartSurveyGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "StartSurvey");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodStartSurveyPostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "StartSurvey");
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodAnswerNextGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "AnswerNext");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodAnswerNextPostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "AnswerNext");
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodFinalizePendingContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethod("FinalizePending");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodDeletePendingGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "DeletePending");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodDeletePendingPostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "DeletePending");
        ...
        public void TestControllerMethodCreatePostContainsExpectedAttributes1()
        {
            ...
            #region Act
            var expectedAttribute = controllerMethod.ElementAt(1).GetCustomAttributes(true).OfType<UserAttribute>();
            var allAttributes = controllerMethod.ElementAt(1).GetCustomAttributes(true);
            #endregion Act
        ...
        public void TestControllerMethodResultsContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "Results");
            #endregion Arrange
